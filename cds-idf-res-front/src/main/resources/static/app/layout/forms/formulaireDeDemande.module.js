define(['angular',
        '../../app/layout/forms/formulaireDeDemande.controller'
        ], function (angular, FormulaireDeDemandeController) {
/*
                   .___    .__
...
*/
  ...
  angular.module('app.model',['ui.grid.selection'])
           .config(['$routeProvider',
            ...
            .controller('FormulaireDeDemandeController', FormulaireDeDemandeController)
            ;
});
