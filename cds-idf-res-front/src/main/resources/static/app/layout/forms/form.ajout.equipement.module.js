define(['angular',
        '../../app/layout/forms/Form_Ajout_Equipement.controller'
        ], function (angular, AjoutEquipementController) {
/*
                   .___    .__
...
*/
  ...
  angular.module('app.model',['ui.grid.selection'])
           .config(['$routeProvider',
            ...
            .controller('AjoutEquipementController', AjoutEquipementController)
            ;
});
